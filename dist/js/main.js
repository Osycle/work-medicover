...
$(function(){
  ...
  // Flikity Carousel
	...
	//$.fancybox.open('');
	if( $(".short-productions-carousel .carousel-items figure").length > 1 )
	var carouselAdvert = $('.short-productions-carousel .carousel-items').flickity({
		imagesLoaded: true,
		autoPlay: false,
		pauseAutoPlayOnHover: true,
		arrowShape: arrowStyle,
  ...
  if( $('.carousel-reviews .carousel-items figure').length > 2 )
    $('.carousel-reviews .carousel-items').flickity({
      imagesLoaded: true,
      autoPlay: false,
      pauseAutoPlayOnHover: true,
      arrowShape: arrowStyle,
		...
		onResized(function(){
	  	...
	  	if( revSlider )
		   revSlider.revolution({
					...
					startheight: checkSm() ? 200 :  bannerSlider ? 350 : 450,
					autoHeight:"off",
